...
\textsc{Note.}
\begin{enumerate}
\li This is the end of this problem for us, but the story of this conjecture
...
\li You should write the obvious version without bitwise optimization
and without the mod 4 optimization and compare the runtime of the two
functions.
\end{enumerate}
